...
from .utils import get_subgraphs_as_molecules_all, get_structure_list, read_robust_pymatgen, get_duplicates_ktree
import numpy as np
import logging
...
class Checker():
    ...
    def check_clashing(s: Structure, threshold: float = 0.3) -> bool:
        ...
        duplicates = get_duplicates_ktree(s, threshold)
    ...
    def flag_potential_problems(structure_path: str,
        ...
        try:
            s = read_robust_pymatgen(structure_path)
        except:
